...
| Via hole / outer copper diameter | 0.20 / 0.40 mm |
| Via radial annular ring | 0.10 mm |
...
JLCPCB lists these via dimensions as supported; the 0.20/0.40 mm combination may
incur an additional charge. If changing outer diameters for cost, rerun routing

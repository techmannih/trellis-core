...
<silkscreenpath strokeWidth="0.15mm" route={[{"x":1.0500105999999505,"y":-1.0311891999999716},{"x":1.0500105999999505,"y":-1.0500359999999773}]} />
<silkscreenpath strokeWidth="0.15mm" route={[{"x":-1.0499597999998969,"y":1.0310622000000649},{"x":-1.0499597999998969,"y":1.0499344000000974},{"x":1.0500105999999505,"y":1.0499344000000974},{"x":1.0500105999999505,"y":1.0310622000000649}]} />
<silkscreenpath strokeWidth="0.15mm" route={[{"x":1.0500105999999505,"y":-1.0500359999999773},{"x":-1.0499597999998969,"y":-1.0500359999999773},{"x":-1.0499597999998969,"y":-1.0311891999999716}]} />
{/* PCB dot identifies pin 1 / DIN; see docs/assembly.md for the top-view map. */}
<silkscreencircle pcbX="1.7mm" pcbY="-1.05mm" radius="0.2mm" strokeWidth="0.18mm" />
<fabricationnotetext text="1 DIN" pcbX="1.8mm" pcbY="-2.0mm" fontSize="0.5mm" />
<fabricationnotepath route={[{ x: 1.8, y: -1.6 }, { x: 0.86995, y: -0.499999 }]}
  strokeWidth="0.15mm" />

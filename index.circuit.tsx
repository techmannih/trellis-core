...
export const TrellisCore = () => (
  <board
    ...
    height="50mm"
    borderRadius="3mm"
    // All components are assembled on top; four copper layers provide routing and GND.
    layers={4}
    thickness="1.6mm"
  ...
  >
    ...
    {/* Dedicated top-side bypass routes, each limited to 3 mm with no vias.
        Escape waypoints use U3 footprint coordinates (U3 is rotated 90° on the PCB). */}
    <trace
      name="DECOUPLE_C7"
      from=".U2 > .VIN"
      to=".C7 > .pin1"
    ...
    <trace
      ...
      maxLength="3mm"
      pcbPath={[
        { x: 8.500000, y: -0.999998 },
        { x: 9.000000, y: -1.500007 },
      ]}
    />
    <trace
      name="DECOUPLE_C27"
    ...
    <trace
      ...
      maxLength="3mm"
      pcbPath={[
        { x: 8.500000, y: -0.199898 },
        { x: 9.000000, y: -0.550007 },
      ]}
    />
    <trace
      name="DECOUPLE_C30"
    ...
    <trace
      ...
      maxLength="3mm"
      pcbPath={[
        // Stagger this corner away from the neighboring C24 escape.
        { x: 8.600000, y: 0.599948 },
        { x: 9.000000, y: 1.349993 },
      ]}
    />
    <trace
      name="DECOUPLE_C26"
    ...
    <trace
      ...
      pcbPath={[
        { x: 3.4, y: -8.5 },
        // Clear both the LXOUT diagonal and C17 with 0.15 mm traces.
        { x: 2.8, y: -9.145 },
        { x: 2.8, y: -11.9 },
        { x: 4.6, y: -11.9 },
      ]}
